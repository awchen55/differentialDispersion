...
input_name_res = path + "simulation_metrics_residuals_2.csv"
input_name_metrics = path + "simulation_metrics_2.csv"
output_name = path + "simulation_bootstrap_results_2.csv"


# cell data
cell_df_t = pd.read_csv(path + "Y_2_cpm.csv",sep=" ", header=None)
...
merged = nb_metrics.T.merge(nb_res.T,left_index=True, right_index=True)[["cv","umi","cell_cnt","lowess"]]
