...
We run the power analysis by simulating 1,000 times for $B=1,000$ bootstrapping iterations. We test out 100 different effect sizes for the applied factor to the varaince, spanned evenly between 1 and 2. 
...
### ***Power Analysis Across Effect Size per Individuals***
