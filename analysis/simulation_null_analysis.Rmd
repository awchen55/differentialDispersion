...
We compare CPM vs log(CPM) normalization. We see the increase effect of the factor. For high expressed genes, we see the mean-variance relationship, which may make it difficult to identify signifcantly dispersed genes.
```{r}
par(mfrow = c(2, 2))
