...
TP <- c(nrow(overlap_sig_1.25),nrow(overlap_sig_1.5), nrow(overlap_sig_1.75), nrow(overlap_sig_2))
FN <- n_disp - TP
FP <- n_positive - TP
TN <- n_genes - n_disp - FP
...
cbind(applied_factor,TP,FN,FP,TN,FNR, FPR, FDR)
```
