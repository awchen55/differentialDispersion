...
# Y_2 <- sim_Y(n,p,sigma,2,Li,mean_intervals)
...
We run the pipeline to identify genes with significant dispersion.
```{r load results}
...
sim2 <- read.csv(file.path(path,"simulation_bootstrap_results_2.csv"))
...
We show the number of genes identified as significantly dispersed. We show the number of true significantly dispersed genes captured.
```{r summary of results}
library(dplyr)

applied_factor <- c(1.25, 1.5, 1.75, 2)
n_positive <- c(nrow(sim1.25_sig),nrow(sim1.5_sig), nrow(sim1.75_sig), nrow(sim2_sig))
positive_rate <- n_positive/10000

n_true_positive <- c(nrow(overlap_sig_1.25),nrow(overlap_sig_1.5), nrow(overlap_sig_1.75), nrow(overlap_sig_2))
true_positive_rate <- n_true_positive/500

cbind(applied_factor,n_positive,positive_rate,n_true_positive,true_positive_rate)
```
...
#library(MASS)
# write.matrix(Y_1.25_cpm$Y_cpm_normalized,file="/project2/gilad/awchen55/differentialDispersion/data/simulations/Y_1.25_cpm.csv")
# 
# write.matrix(Y_1.5_cpm$Y_cpm_normalized,file="/project2/gilad/awchen55/differentialDispersion/data/simulations/Y_1.5_cpm.csv")
# write.matrix(Y_1.75_cpm$Y_cpm_normalized,file="/project2/gilad/awchen55/differentialDispersion/data/simulations/Y_1.75_cpm.csv")
# write.matrix(Y_2_cpm$Y_cpm_normalized,file="/project2/gilad/awchen55/differentialDispersion/data/simulations/Y_2_cpm.csv")

write.csv(matrix(Y_1.25$disp_idx, nrow=1), file ="/project2/gilad/awchen55/differentialDispersion/data/simulations/sim_sig_disp_idx_1.25.csv")
write.csv(matrix(Y_1.5$disp_idx, nrow=1), file ="/project2/gilad/awchen55/differentialDispersion/data/simulations/sim_sig_disp_idx_1.5.csv")
write.csv(matrix(Y_1.75$disp_idx, nrow=1), file ="/project2/gilad/awchen55/differentialDispersion/data/simulations/sim_sig_disp_idx_1.75.csv")
write.csv(matrix(Y_2$disp_idx, nrow=1), file ="/project2/gilad/awchen55/differentialDispersion/data/simulations/sim_sig_disp_idx_2.csv")
```
